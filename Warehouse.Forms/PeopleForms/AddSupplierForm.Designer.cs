namespace WarehouseManagmentSystem.WinForms.PeopleForms
{
    partial class AddSupplierForm
    {
        ...
        {
            SuplierDataGridView = new DataGridView();
            ...
            ((System.ComponentModel.ISupportInitialize)SuplierDataGridView).BeginInit();
            tableLayoutPanel1.SuspendLayout();
            SuspendLayout();
            // 
            // SuplierDataGridView
            // 
            SuplierDataGridView.AccessibleName = "personDataGridView";
            SuplierDataGridView.AllowUserToAddRows = false;
            SuplierDataGridView.AllowUserToDeleteRows = false;
            SuplierDataGridView.AllowUserToOrderColumns = true;
            SuplierDataGridView.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            SuplierDataGridView.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            SuplierDataGridView.Dock = DockStyle.Top;
            SuplierDataGridView.Location = new Point(0, 0);
            SuplierDataGridView.Name = "SuplierDataGridView";
            SuplierDataGridView.ReadOnly = true;
            SuplierDataGridView.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.AutoSizeToAllHeaders;
            SuplierDataGridView.Size = new Size(2329, 324);
            SuplierDataGridView.TabIndex = 28;
            // 
            // tableLayoutPanel1
            // 
            ...
            Controls.Add(SuplierDataGridView);
            Name = "AddSupplierForm";
            StartPosition = FormStartPosition.CenterParent;
            Text = "Add Supplier";
            WindowState = FormWindowState.Maximized;
            Load += AddSupplierForm_Load;
            ((System.ComponentModel.ISupportInitialize)SuplierDataGridView).EndInit();
        ...
        #endregion
        private DataGridView SuplierDataGridView;
